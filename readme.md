...
## Core Focus
- **Azure migration delivery:** wave planning, readiness gates, change coordination, and cutover execution  
- **Discovery & dependency mapping:** inventory validation, application/server dependencies, risk & impact analysis, and sequencing support  
- **Cutover-critical infrastructure:** VLAN/gateway cutovers, routing validation, connectivity verification, and rapid issue triage during bridges  
- **Operational enablement:** runbooks, SOPs, onboarding guides, monitoring/readiness checklists, and clean handoffs to operations  
- **Program coordination:** aligning engineering, PMO, infrastructure, app owners, and vendors across time zones with clear status + accountability  
...
## Skills & Tools
**Cloud:** Azure migrations, readiness planning, wave management  
