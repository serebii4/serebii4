...
<div align="center">
  ...
  <p style="margin-top: 12px;">
    ...
    <img alt="AZ-104" src="https://img.shields.io/badge/AZ--104-In%20Progress-F59E0B" />
  </p>
</div>
<br/>
<table width="100%">
...
<div style="border: 1px solid #d0d7de; border-radius: 16px; padding: 16px;">
  ...
  <ul style="margin: 0; padding-left: 18px; line-height: 1.6;">
    ...
    <li><b>Discovery & dependency mapping:</b> inventory validation, app/server dependencies, risk & impact analysis, sequencing</li>
    <li><b>Cutover-critical infrastructure:</b> VLAN/gateway cutovers, routing validation, connectivity verification, rapid issue triage</li>
...
<div style="border: 1px solid #d0d7de; border-radius: 16px; padding: 16px;">
  ...
  <p style="margin: 0 0 10px; line-height: 1.6;">
    <b>AI/LLMs</b><br/>
    ChatGPT • Gemini • Claude • z.ai • local model deployments • prompt engineering
  </p>
